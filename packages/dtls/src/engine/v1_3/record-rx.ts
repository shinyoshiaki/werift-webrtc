 ...
 */
export function handleDatagram(
  this: Dtls13Host,
 ...
 */
export function resolveEpochCandidates(
  this: Dtls13Host,
  low: number,
): EpochProtection[] {
 ...
 */
export async function finishHandshakeRecordAck(
  this: Dtls13Host,
 ...
 */
export function hasProtectedWriteKeys(this: Dtls13Host): boolean {
  return this.writeEpoch >= 2 || this.connected;
}

export async function onPlaintextRecordAsync(
  this: Dtls13Host,
  rec: {
    contentType: number;
    epoch: number;
 ...
 */
export async function onCiphertextRecordAsync(
  this: Dtls13Host,
  rec: {
    contentType: number;
    epoch: number;
 ...
 */
export async function processHandshakeBytes(
  this: Dtls13Host,
 ...
 */
export function isAllowedHandshake(
  this: Dtls13Host,
  msgType: number,
  epoch: number,
): boolean {
...
export async function enqueueHandshake(
  this: Dtls13Host,
...
export function evictExpiredFragments(this: Dtls13Host): void {
  const now = Date.now();
