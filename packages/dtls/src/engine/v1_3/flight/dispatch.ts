 ...
 */
export abstract class Dtls13FlightDispatch extends Dtls13RecordRx {
  /**
  ...
  protected abstract onClientHello(
    body: Buffer,
    messageSeq: number,
  ): Promise<void>;
  protected abstract onServerHello(
    body: Buffer,
    messageSeq: number,
  ): Promise<void>;
  protected abstract onEncryptedExtensions(body: Buffer): Promise<void>;
  protected abstract onCertificateRequest(body: Buffer): Promise<void>;
  protected abstract onCertificate(body: Buffer): Promise<void>;
  protected abstract onCertificateVerify(body: Buffer): Promise<void>;
  protected abstract onFinished(body: Buffer, epoch: number): Promise<void>;
  protected abstract onKeyUpdate(body: Buffer): void;
