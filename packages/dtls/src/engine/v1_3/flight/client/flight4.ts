...
import { Dtls13ClientFlight1 } from "./flight1";

/**
 * Flight 4 receive (client): ServerHello / HRR, EncryptedExtensions, CertificateRequest.
 * HRR loops back to Flight 1/3 via {@link Dtls13ClientFlight1.sendClientHello}.
 */
export abstract class Dtls13ClientFlight4 extends Dtls13ClientFlight1 {
