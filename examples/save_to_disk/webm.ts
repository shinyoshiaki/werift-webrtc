...
import { BitWriter, bufferWriter } from "../../packages/common/src";
...
server.on("connection", async (socket) => {
...

  {
    ...
    transceiver.onTrack.subscribe((track) => {
      ...
      const sampleBuilder = new SampleBuilder(Vp8RtpPayload);
  ...
  }
  {
    ...
    transceiver.onTrack.subscribe((track) => {
      ...
      const sampleBuilder = new SampleBuilder(OpusRtpPayload);
      ...
      track.onReceiveRtp.subscribe((rtp) => {
        ...
        const trackNumber: Uint8Array = EBML.vintEncodedNumber(2).bytes;
